        ...
        <TimelineItem>
          ...
          <TimelineContent>
            <Paper elevation={3} className={classes.paper}>
              ...
              <br />
              <Typography>We Provide Wide Range of Cars</Typography>
            </Paper>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
          ...
          <TimelineContent>
            <Paper elevation={3} className={classes.paper}>
              <Typography variant="h6" component="h1">
                Select The Perfect Car For You.
              </Typography>
              <br />
              <Typography>From Rent-a-Car's broad range of cars</Typography>
            </Paper>
          </TimelineContent>
        </TimelineItem>
        <TimelineItem>
