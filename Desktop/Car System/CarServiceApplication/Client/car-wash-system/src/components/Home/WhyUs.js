    ...
    <div className="component">
      <div className="banner">
        ...
        <div className="banner__contentRight">
          <br /> <br /> <br />
          <h1 className="banner__heading">Car Rental Within Your Reach</h1>
          <br></br>
          <p className="banner__para">
            We guarantee fast and quality service 
          </p>
        </div>
      </div>
      ...
      <div className="banner">
        <div className="banner__contentLeft">
          ...
          <p className="banner__para">
            We are committed to provide you quality service.
          </p>
          <p className="points">
            <CheckIcon color="secondary" />
            Quality Delivery.
          ...
          <p className="points">
            <CheckIcon color="secondary" /> Genuine Cars.
          </p>
          <p className="points">
            <CheckIcon color="secondary" />
            Service warranty.
